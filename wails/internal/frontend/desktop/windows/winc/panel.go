...
func NewPanel(parent Controller) *Panel {
	...
	pa.hwnd = CreateWindow("winc_Panel", parent.Handle(), w32.WS_EX_CONTROLPARENT, w32.WS_CHILD|w32.WS_VISIBLE)
	pa.parent = parent
	RegMsgHandler(pa)
...
func (epa *ErrorPanel) init(parent Controller) {
	...
	epa.hwnd = CreateWindow("winc_ErrorPanel", parent.Handle(), w32.WS_EX_CONTROLPARENT, w32.WS_CHILD|w32.WS_VISIBLE)
	epa.parent = parent
...
func NewMultiPanel(parent Controller) *MultiPanel {
	...
	mpa.hwnd = CreateWindow("winc_MultiPanel", parent.Handle(), w32.WS_EX_CONTROLPARENT, w32.WS_CHILD|w32.WS_VISIBLE)
	mpa.parent = parent
	RegMsgHandler(mpa)
