...
func NewVResizer(parent Controller) *VResizer {
	...
	sp.hwnd = CreateWindow("winc_VResizer", parent.Handle(), w32.WS_EX_CONTROLPARENT, w32.WS_CHILD|w32.WS_VISIBLE)
	sp.parent = parent
	sp.mouseLeft = true
	RegMsgHandler(sp)
...
func NewHResizer(parent Controller) *HResizer {
	...
	sp.hwnd = CreateWindow("winc_HResizer", parent.Handle(), w32.WS_EX_CONTROLPARENT, w32.WS_CHILD|w32.WS_VISIBLE)
	sp.parent = parent
	sp.mouseLeft = true
	RegMsgHandler(sp)
