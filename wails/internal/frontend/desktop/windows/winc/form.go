...
func NewCustomForm(parent Controller, exStyle int, dwStyle uint) *Form {
	...
	fm.hwnd = CreateWindow("winc_Form", parent.Handle(), uint(exStyle), dwStyle)
	fm.parent = parent
...
func NewForm(parent Controller) *Form {
	...
	fm.isForm = true
	fm.hwnd = CreateWindow("winc_Form", parent.Handle(), w32.WS_EX_CONTROLPARENT|w32.WS_EX_APPWINDOW, w32.WS_OVERLAPPEDWINDOW)
	fm.parent = parent
